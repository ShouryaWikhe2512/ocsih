  ...
  try {
    ...
    const sampleReports = [
      {
        ...
        description:
          "Suspicious activity near the ticket counter. Someone was trying to pickpocket passengers.",
      ...
      },
      {
        ...
        description:
          "Fight broke out between two passengers over seat. Security was called.",
      ...
      },
      {
        ...
        description:
          "Car break-in reported in parking lot. Window was smashed.",
      ...
      },
      {
        ...
        description:
          "Online fraud case - someone impersonating bank officials asking for OTP.",
      ...
      },
      {
        ...
        description:
          "Graffiti and vandalism on metro walls. Property damage reported.",
    ...
    const aiAnalyses = [
      {
        ...
        severity: "HIGH",
        description:
          "High confidence pickpocketing activity detected based on behavior patterns.",
        ...
        people: JSON.stringify([
          "Suspect: Male, 25-30 years, wearing blue shirt",
        ]),
      ...
      },
      {
        ...
        severity: "MEDIUM",
        description:
          "Physical altercation between passengers over seating dispute.",
        riskFactors: JSON.stringify([
          "Peak hours",
          "Limited seating",
          "Tension between passengers",
        ]),
        recommendations: JSON.stringify([
          "Mediation training for staff",
          "Clear seating policies",
        ]),
    ...
    await prisma.humanVerification.create({
      data: {
        ...
        isVerified: true,
        notes:
          "Verified by Inspector Rajesh Kumar. Evidence is clear and credible.",
        confidence: 95,
    ...
    console.log(
      `📊 Created ${users.length} users, ${createdReports.length} crime reports, ${aiAnalyses.length} AI analyses, and 1 human verification`
    );
  } catch (error) {

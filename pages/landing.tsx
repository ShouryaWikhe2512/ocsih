    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50">
      ...
      <div className="relative z-10 pt-20 pb-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Portal Selection Cards */}
          <div
            className={`grid lg:grid-cols-2 gap-6 mb-10 transition-all duration-1000 delay-300 ${
              isLoaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            ...
            <div
              className={`group relative cursor-pointer transition-all duration-500 ${
                selectedCard === "analyst" ? "scale-102" : "hover:scale-101"
              }`}
              onClick={() => handleCardSelect("analyst")}
              style={{
                filter:
            ...
            >
              <div className="relative overflow-hidden bg-white/90 backdrop-blur-xl rounded-2xl border border-white/60 p-6 h-full">
                {/* Selection Indicator */}
                {selectedCard === "analyst" && (
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shadow-xl animate-pulse">
            ...
            <div
              className={`group relative cursor-pointer transition-all duration-500 ${
                selectedCard === "authority" ? "scale-102" : "hover:scale-101"
              }`}
              onClick={() => handleCardSelect("authority")}
              style={{
                filter:
            ...
            >
              <div className="relative overflow-hidden bg-white/90 backdrop-blur-xl rounded-2xl border border-white/60 p-6 h-full">
                {/* Selection Indicator */}
                {selectedCard === "authority" && (
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shadow-xl animate-pulse">
                    <ArrowRight className="w-3 h-3 text-white" />
                  </div>
                )}
          ...
          {/* Footer */}
          <div
            className={`text-center mt-10 transition-all duration-1000 delay-900 ${
              isLoaded ? "opacity-100" : "opacity-0"
            }`}
          >
